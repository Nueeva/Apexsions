package com.apex.battlepass.gui.main;
...
import com.apex.battlepass.leaderboard.LeaderboardEntry;
...
public class BattlePassLeaderboardMenu extends Gui {
    ...
    public void initialize() {
        ...
        double myRupiah = 0.0;
        try {
            myRupiah = com.apex.economy.api.ApexsionsEconomyAPI.getBalance(player.getUniqueId(), "rupiah");
        } catch (Throwable t) {
        ...
        for (int i = 0; i < PYRAMID_SLOTS.length; i++) {
            ...
            try {
                entryRupiah = com.apex.economy.api.ApexsionsEconomyAPI.getBalance(entry.getUuid(), "rupiah");
            } catch (Throwable t) {
