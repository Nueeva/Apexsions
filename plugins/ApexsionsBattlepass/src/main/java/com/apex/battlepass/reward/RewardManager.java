...
import com.apex.battlepass.api.event.BattlePassRewardClaimEvent;
        ...
        switch (reward.getType()) {
            ...
            case CURRENCY -> {
                ...
                if (cId == null || cId.equalsIgnoreCase("battle_coins") || cId.equalsIgnoreCase("battlecoins")) {
                    ...
                    try {
                        com.apex.economy.api.ApexsionsEconomyAPI.deposit(player.getUniqueId(), cId, reward.getAmount());
                    } catch (Throwable t) {
