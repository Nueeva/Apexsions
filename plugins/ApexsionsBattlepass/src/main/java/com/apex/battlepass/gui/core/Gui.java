package com.apex.battlepass.gui.core;
...
public abstract class Gui {
    ...
    public Gui(ApexsionsBattlepass plugin, Player player, String title, int size, Gui parent) {
        this.plugin = plugin != null ? plugin : ApexsionsBattlepass.getInstance();
        this.player = player;
    ...
    public Gui(ApexsionsBattlepass plugin, Player player, String title, int size) {
    ...
    public void fillBackground() {
        ...
        if (plugin != null && plugin.getGuiConfig() != null) {
            String matName = plugin.getGuiConfig().getString("filler.material", "BLACK_STAINED_GLASS_PANE");
            if (matName != null) {
                Material matched = Material.matchMaterial(matName);
                if (matched != null) fillerMat = matched;
            }
        }
        fillBackground(fillerMat);
    }
