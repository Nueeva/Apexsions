...
const APX_I18N = {
    id: {
        ...
        nav_realm: 'Realm',
        nav_feed: 'Kronik Realm',
        nav_bounties: 'Papan Buronan',
        nav_map: 'Atlas Realm',
        nav_shop: 'Webstore',
        nav_more: 'Lainnya',
        nav_wiki: 'Wiki',
        ...
        // Hero
        hero_brand_mark: 'APEXSIONS • SERVER MINECRAFT INDONESIA',
        ...
        hero_headline: 'The Peak Civilizations',
        hero_subtext: 'Sebelas kasta sosial, tiga pilihan kerajaan, dan dunia survival yang dibangun langsung oleh para pemain.',
        hero_btn_explore: 'JELAJAHI KERAJAAN',
        ...
        hero_citizens: 'Warga',
        // Server Map Section (Tactical Cartography & Sovereign Atlas)
        map_kicker: 'PETA 3D LIVE',
        map_title: 'Jelajahi Dunia Apexsions dalam 3D',
        map_lead: 'Lihat seluruh dunia Apexsions secara real-time lewat BlueMap 3D. Pantau wilayah kerajaan, pemukiman warga, dan aktivitas pemain langsung dari browser.',
        map_status_online: 'ATLAS ONLINE',
        map_status_standby: 'ATLAS STANDBY',
        map_feat_persp_title: 'Navigasi Bebas 360°',
        map_feat_persp_desc: 'Rotasi bebas, sudut isometrik, dan inspeksi detail kontur dunia.',
        map_feat_track_title: 'Posisi Pemain Live',
        map_feat_track_desc: 'Pantau koordinat dan posisi pemain yang sedang online secara real-time.',
        map_feat_bounds_title: 'Wilayah 3 Kerajaan',
        map_feat_bounds_desc: 'Visualisasi batas wilayah Zenithar, Solterra, dan Sylvamoor.',
        map_btn_open: 'Buka Peta 3D BlueMap',
        map_tab_note: 'Buka BlueMap Full Screen di Tab Baru',
        map_viewport_tag: 'BLUEMAP 3D // LIVE',
        map_viewport_title: 'Peta 3D Tiga Kerajaan',
        map_viewport_prompt: 'BUKA PETA LAYAR PENUH',
        map_telemetry_center: 'PUSAT TIGA KERAJAAN',
        map_hud_scope: 'STATUS MAP: AKTIF',

        // World & Lore
        world_kicker: 'LORE & TIGA KERAJAAN',
        ...
        zenithar_link: 'Pelajari Kerajaan Zenithar',
        ...
        solterra_link: 'Pelajari Kerajaan Solterra',
        ...
        sylvamoor_link: 'Pelajari Kerajaan Sylvamoor',
        ...
        // Caste Hierarchy
        caste_kicker: 'SISTEM RANK & KASTA',
        caste_title: 'Hierarki 11 Kasta Apexsions',
        caste_lead: 'Dari pemain baru (Wanderer) hingga jajaran founder, setiap rank memiliki weight, batas klaim wilayah, dan hak istimewa tersendiri di server.',
        ...
        caste_filter_pioneers: 'WARGA BARU (1)',
        caste_tab_authority: 'Founder & Otoritas (3)',
        caste_tab_nobles: 'Rank Donatur (5)',
        caste_tab_staff: 'Staf & Moderator (2)',
        caste_tab_foundation: 'Warga Baru (1)',
        dock_civ: 'Kerajaan',
        dock_map: 'Peta 3D',
        dock_ranks: 'Kasta',
        ...
        // Onboarding
        step_kicker: 'PANDUAN PEMULA',
        step_title: 'Cara Masuk ke Server Apexsions',
        step_lead: 'Tiga langkah mudah untuk mulai bermain di Java Edition maupun Bedrock Edition.',
        step1_phase: 'LANGKAH 1',
        ...
        step3_btn_register: 'Daftar Akun Web',
        guide_callout_badge: 'PANDUAN KILAT PEMAIN BARU',
        guide_callout_title: 'Baru Pertama Kali Masuk ke Server?',
        guide_callout_desc: 'Pelajari panduan 15 menit pertama: cara mengambil starter kit, memilih kerajaan, klaim lahan rumah, hingga mencari uang Rupiah pertama.',
        guide_callout_btn: 'Buka Panduan 15 Menit',

        // Footer
        footer_desc: 'Apexsions adalah server Minecraft Survival & Kingdom Indonesia di versi 26.2 dengan 3 kerajaan unik, ekonomi dinamis, dan sistem kasta kompetitif.',
        footer_subline: 'MINECRAFT 26.2 • SURVIVAL & KINGDOM',
        ...
        rules_r2_1_prev: 'Modul AntiXrayListener membatasi jangkauan raytrace interaksi blok (maks 5.8m), memantau anomali kecepatan penambangan bijih berharga (alert staf jika menambang >8 diamond/debris dalam 60s), serta didukung obfuscation ore Paper Engine Native (Anti-Xray mode 2).',
        ...
        rules_r2_3_prev: 'Sistem kedaulatan tanah (/claim, /trust, /unclaim) dan ClaimProtectionListener secara otomatis membatalkan event pembongkaran blok, penempatan blok, penuangan cairan, dan pembukaan peti oleh pemain luar. Pemain dapat memvisualisasikan batas tanah via /claim info.',
        ...
        profile_pub_unlinked: 'Karakter In-Game',
        profile_pub_claim_hint: 'Ketik /link di Minecraft untuk klaim web',
    ...
    en: {
        ...
        nav_leaderboard: 'Leaderboard',
        nav_realm: 'Realm',
        nav_feed: 'Realm Chronicles',
        nav_bounties: 'Bounty Board',
        nav_map: 'Realm Atlas',
        nav_shop: 'Webstore',
        nav_more: 'More',
        nav_wiki: 'Wiki',
        ...
        // Hero
        hero_brand_mark: 'APEXSIONS • MINECRAFT SERVER INDONESIA',
        ...
        hero_headline: 'The Peak Civilizations',
        hero_subtext: 'Eleven social castes, three distinct kingdoms, and a survival world shaped directly by its players.',
        hero_btn_explore: 'EXPLORE KINGDOMS',
        ...
        // Server Map Section (Tactical Cartography & Sovereign Atlas)
        map_kicker: 'LIVE 3D MAP',
        map_title: 'Explore The Apexsions World in 3D',
        map_lead: 'View the world of Apexsions in real-time via interactive 3D BlueMap. Observe kingdom territories, player settlements, and server activity directly from your browser.',
        map_status_online: 'ATLAS ONLINE',
        map_status_standby: 'ATLAS STANDBY',
        map_feat_persp_title: 'Unconstrained 360° View',
        map_feat_persp_desc: '360° orbital rotation, isometric angles, and detailed block-level terrain inspection.',
        map_feat_track_title: 'Live Player Tracking',
        map_feat_track_desc: 'Track live player coordinates and online movements in real-time across the world.',
        map_feat_bounds_title: 'Three Kingdom Borders',
        map_feat_bounds_desc: 'Clear boundary outlines for Zenithar, Solterra, and Sylvamoor territories.',
        map_btn_open: 'Open BlueMap 3D',
        map_tab_note: 'Open Full Screen BlueMap in New Tab',
        map_viewport_tag: 'BLUEMAP 3D // LIVE',
        ...
        map_hud_scope: 'MAP STATUS: ACTIVE',

        // World & Lore
        world_kicker: 'LORE & THREE KINGDOMS',
        ...
        zenithar_link: 'Learn About Zenithar',
        ...
        solterra_link: 'Learn About Solterra',
        ...
        sylvamoor_link: 'Learn About Sylvamoor',
        ...
        // Caste Hierarchy
        caste_kicker: 'RANK & CASTE SYSTEM',
        caste_title: '11 Caste Hierarchy of Apexsions',
        caste_lead: 'From new citizens (Wanderer) to ancestral founders, each rank features distinct weight, land claim limits, and server privileges.',
        caste_filter_all: 'ALL CASTES (11)',
        caste_filter_apex: 'ANCESTRAL APEX (1)',
        caste_filter_authority: 'COUNCIL OF AUTHORITY (2)',
        caste_filter_staff: 'ADMINISTRATION & STAFF (2)',
        caste_filter_nobles: 'DONATOR ORDERS (5)',
        caste_filter_pioneers: 'NEW CITIZENS (1)',
        caste_tab_authority: 'Founders & Authority (3)',
        caste_tab_nobles: 'Donator Ranks (5)',
        caste_tab_staff: 'Staff & Moderators (2)',
        caste_tab_foundation: 'New Citizens (1)',
        dock_civ: 'Kingdoms',
        dock_map: '3D Map',
        dock_ranks: 'Castes & Ranks',
        dock_join: 'How to Join',

        // Onboarding
        step_kicker: 'BEGINNER GUIDE',
        step_title: 'How to Join Apexsions',
        step_lead: 'Three simple steps to start playing on Java Edition or Bedrock Edition.',
        step1_phase: 'STEP 1',
        ...
        step3_btn_register: 'Register Web Account',
        guide_callout_badge: 'QUICK STARTER GUIDE',
        guide_callout_title: 'First Time Joining the Server?',
        guide_callout_desc: 'Read the 15-minute starter guide: how to claim starter kits, choose a kingdom, protect your land, and earn your first coins.',
        guide_callout_btn: 'Open 15-Minute Guide',

        // Footer
        footer_desc: 'Apexsions is an Indonesian Minecraft Survival & Kingdom server on version 26.2 with 3 unique kingdoms, dynamic economy, and competitive castes.',
        footer_subline: 'MINECRAFT 26.2 • SURVIVAL & KINGDOM',
        ...
        rules_r2_1_prev: 'The AntiXrayListener module enforces raytrace reach limits (max 5.8m), tracks abnormal ore mining velocity spikes (staff alerts when mining >8 diamonds/debris in 60s), supported by Paper Engine Native ore obfuscation (Anti-Xray mode 2).',
        ...
        rules_r2_3_prev: 'The sovereign land claiming system (/claim, /trust, /unclaim) and ClaimProtectionListener automatically block block-break, block-place, fluid dumping, and container access for outsiders. Claim boundaries can be visualized with /claim info.',
        ...
        profile_pub_unlinked: 'In-Game Character',
        profile_pub_claim_hint: 'Type /link in Minecraft to claim on web',
        kingdom_zenithar_name: 'Zenithar',
        kingdom_solterra_name: 'Solterra',
        kingdom_sylvamoor_name: 'Sylvamoor',
        kingdom_aetherion_name: 'Aetherion (The Conclave)',
