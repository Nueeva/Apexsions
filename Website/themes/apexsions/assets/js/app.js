...
const APX_I18N = {
    id: {
        ...
        map_kicker: 'KARTOGRAFI REALM',
        map_title: 'Eksplorasi Bentang Alam Apexsions',
        map_lead: 'Jelajahi peradaban Apexsions secara langsung melalui visualisasi 3D interaktif beresolusi tinggi. Pantau benteng kerajaan, persebaran warga, serta batas wilayah kedaulatan dari sudut pandang bebas tanpa batas.',
        map_status_online: 'ATLAS ONLINE',
        map_status_standby: 'ATLAS STANDBY',
        map_feat_persp_title: 'Perspektif 3D Bebas',
        map_feat_persp_desc: 'Rotasi orbital 360°, sudut isometrik, dan inspeksi topografi kontur dunia.',
        map_feat_track_title: 'Pelacakan Warga',
        map_feat_track_desc: 'Pantau koordinat pergerakan pemain dan pemukiman secara real-time.',
        map_feat_bounds_title: 'Teritorial 3 Kerajaan',
        map_feat_bounds_desc: 'Visualisasi batas kedaulatan Zenithar, Solterra, dan Sylvamoor.',
        map_btn_open: 'Buka Atlas Satelit 3D',
        map_tab_note: 'Satelit BlueMap Resolusi Penuh',
    ...
    en: {
        ...
        // Server Map Section (Tactical Cartography & Sovereign Atlas)
        map_kicker: 'REALM CARTOGRAPHY',
        map_title: 'Explore The Apexsions World',
        map_lead: 'Explore the civilization of Apexsions directly via high-definition interactive 3D visualization. Observe kingdom citadels, citizen distribution, and territorial borders from an unconstrained aerial vantage.',
        map_status_online: 'ATLAS ONLINE',
        map_status_standby: 'ATLAS STANDBY',
        map_feat_persp_title: 'Unconstrained 3D Vantage',
        map_feat_persp_desc: '360° orbital rotation, isometric angles, and seamless high-definition realm topography observation.',
        map_feat_track_title: 'Citizen Tracking',
        map_feat_track_desc: 'Monitor live player coordinates and settlement expansions in real-time across the world.',
        map_feat_bounds_title: 'Territorial Realm Borders',
        map_feat_bounds_desc: 'Accurate boundary visualization for Zenithar, Solterra, and Sylvamoor sovereign territories.',
        map_btn_open: 'Open 3D Satellite Atlas',
        map_tab_note: 'Full Resolution BlueMap Satellite',
        map_viewport_tag: 'REALM OBSERVER // LIVE',
