    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb apx-breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Peraturan Server</li>
            </ol>
        </nav>

        <!-- Page Header -->
        <div class="apx-section-header text-center mb-5">
            <div class="apx-section-kicker mb-2">TATANAN HUKUM &amp; KEDAULATAN</div>
            <h1 class="apx-section-title display-5 mb-3">Peraturan Resmi Peradaban Apexsions</h1>
        ...
        <div class="d-flex justify-content-center flex-wrap gap-2 mb-5">
            <a href="#pillar-chat" class="btn btn-apx-outline btn-sm py-2 px-3">
                <i class="bi bi-chat-quote-fill me-1 text-gold"></i> I. Chat &amp; Sosial
            </a>
            <a href="#pillar-gameplay" class="btn btn-apx-outline btn-sm py-2 px-3">
                <i class="bi bi-shield-shaded me-1 text-gold"></i> II. Gameplay &amp; Fair Play
            </a>
            <a href="#pillar-ethics" class="btn btn-apx-outline btn-sm py-2 px-3">
                <i class="bi bi-person-check-fill me-1 text-gold"></i> III. Etika &amp; Integritas
            </a>
            <a href="#pillar-security" class="btn btn-apx-outline btn-sm py-2 px-3">
                <i class="bi bi-lock-fill me-1 text-gold"></i> IV. Keamanan &amp; Hukum
            </a>
            <a href="#pillar-sanctions" class="btn btn-apx-outline btn-sm py-2 px-3">
                <i class="bi bi-hammer me-1 text-gold"></i> Matriks Sanksi
            </a>
        </div>
                ...
                <div class="apx-rule-card mb-5" id="pillar-chat">
                    <div class="apx-rule-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="apx-rule-pillar-tag">BAGIAN PERTAMA</span>
                                <h2 class="apx-rule-pillar-title mb-0">I. Aturan Komunikasi &amp; Etika Chat</h2>
                            </div>
                        </div>
                    </div>
                    <div class="apx-rule-card-body">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">1. Spam, Flood &amp; Huruf Kapital Berlebihan</h3>
                                <span class="badge bg-warning-subtle text-warning border border-warning-subtle">Sanksi: Mute</span>
                            </div>
                            <p class="apx-rule-item-desc">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">2. Bahasa Kasar, Provokasi &amp; Konten Tidak Pantas</h3>
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">3. Bullying, Perilaku Toksik &amp; Pelecehan Personal</h3>
                        ...
                        <div class="apx-rule-item mb-0">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">4. Ujaran Kebencian &amp; Pelecehan SARA / Negara / Keluarga</h3>
                ...
                <div class="apx-rule-card mb-5" id="pillar-gameplay">
                    <div class="apx-rule-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="apx-rule-pillar-tag">BAGIAN KEDUA</span>
                                <h2 class="apx-rule-pillar-title mb-0">II. Gameplay, Integritas Wilayah &amp; Fair Play</h2>
                            </div>
                        </div>
                    </div>
                    <div class="apx-rule-card-body">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">1. Penggunaan Cheat, Hack Client &amp; Modifikasi Ilegal</h3>
                                <span class="badge bg-danger text-white">Sanksi: Permanent Ban</span>
                            </div>
                            <p class="apx-rule-item-desc">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">2. Eksploitasi Bug, Glitch &amp; Duplikasi Sumber Daya</h3>
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">3. Griefing &amp; Pencurian di Luar Mekanisme Perang Resmi</h3>
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">4. Eksploitasi Redstone &amp; Mesin Perontok Server (Lag Machine)</h3>
                        ...
                        <div class="apx-rule-item mb-0">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">5. Combat Logging (Kabur Saat Bertarung)</h3>
                ...
                <div class="apx-rule-card mb-5" id="pillar-ethics">
                    <div class="apx-rule-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="apx-rule-pillar-tag">BAGIAN KETIGA</span>
                                <h2 class="apx-rule-pillar-title mb-0">III. Etika, Integritas Akun &amp; Staf</h2>
                            </div>
                        </div>
                    </div>
                    <div class="apx-rule-card-body">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">1. Berbohong kepada Staf &amp; Penghindaran Sanksi (Ban Evasion)</h3>
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">2. Batasan Multi-Akun (Alt Accounts)</h3>
                        ...
                        <div class="apx-rule-item mb-0">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">3. Penyamaran Identitas &amp; Penghormatan Staf</h3>
                                <span class="badge bg-danger-subtle text-danger border border-danger-subtle">Sanksi: Mute &bull; Temp Ban</span>
                            </div>
                            <p class="apx-rule-item-desc">
                ...
                <div class="apx-rule-card mb-5" id="pillar-security">
                    <div class="apx-rule-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="apx-rule-pillar-tag">BAGIAN KEEMPAT</span>
                                <h2 class="apx-rule-pillar-title mb-0">IV. Keamanan, Iklan &amp; Kepatuhan Hukum Negara</h2>
                            </div>
                        </div>
                    </div>
                    <div class="apx-rule-card-body">
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">1. Promosi &amp; Iklan Server Luar Tanpa Izin</h3>
                        ...
                        <div class="apx-rule-item">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">2. Doxxing, Pembocoran Data Pribadi &amp; Ancaman Serangan Cyber</h3>
                        ...
                        <div class="apx-rule-item mb-0">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h3 class="apx-rule-item-title">3. Penipuan Transaksi Riil &amp; Pelanggaran UU ITE</h3>
                                <span class="badge bg-danger text-white">Sanksi: Permanent Ban</span>
                            </div>
                            <p class="apx-rule-item-desc">
                ...
                <div class="apx-rule-card mb-5" id="pillar-sanctions">
                    <div class="apx-rule-card-header">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <span class="apx-rule-pillar-tag">STANDAR YURISDIKSI</span>
                                <h2 class="apx-rule-pillar-title mb-0">Matriks Tingkatan Sanksi &amp; Eskalasi</h2>
                            </div>
                        </div>
                    </div>
                    <div class="apx-rule-card-body p-0">
                        <div class="table-responsive">
                            <table class="table apx-sanction-table mb-0">
                                <thead>
                                    <tr>
                                        <th style="width: 20%;">Tingkat Sanksi</th>
                                        <th style="width: 40%;">Jenis Pelanggaran Terkait</th>
                                        <th style="width: 40%;">Tindakan Penegakan Hukum</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td><span class="badge bg-info-subtle text-info border border-info-subtle">Tingkat I</span></td>
                                        <td>Spam ringan, Caps-Lock berlebihan, pelanggaran format chat.</td>
                                        <td>Peringatan tertulis (Warning) &bull; Mute otomatis 15–60 detik oleh sistem.</td>
                                    </tr>
                                    <tr>
                                        <td><span class="badge bg-warning-subtle text-warning border border-warning-subtle">Tingkat II</span></td>
                                        <td>Toksisitas berulang, provokasi vulgar, AFK farming tanpa batas, redstone lag ringan.</td>
                                        <td>Mute obrolan 1 hingga 24 jam &bull; Kick dari server &bull; Pembersihan mesin lag.</td>
                                    </tr>
                                    <tr>
                                        <td><span class="badge bg-danger-subtle text-danger border border-danger-subtle">Tingkat III</span></td>
                                        <td>Griefing wilayah, pelecehan personal berat, combat logging berulang, promosi server lain.</td>
                                        <td>Temporary Banned 3 hingga 14 hari &bull; Rollback data kerusakan wilayah.</td>
                                    </tr>
                                    <tr>
                                        <td><span class="badge bg-danger text-white">Tingkat IV</span></td>
                                        <td>Cheat/Hack client, duplikasi item, doxxing, SARA ekstrem, penipuan finansial, ban evasion.</td>
                                        <td>Permanent Banned &bull; IP/UUID Blacklist &bull; Penyitaan total aset in-game.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 text-lg-start mb-3 mb-lg-0">
                            <span class="badge mb-2" style="background: rgba(212, 163, 89, 0.2); color: var(--apx-gold-light); border: 1px solid var(--apx-gold-border); font-size: 0.72rem; letter-spacing: 0.08em;">
                                <i class="bi bi-envelope-paper-heart-fill me-1"></i> MEKANISME BANDING
                            </span>
                        ...
                        <div class="col-lg-4 text-lg-end">
                            <a href="https://discord.gg/apexsions" target="_blank" rel="noopener noreferrer" class="btn btn-apx-gold">
                                <i class="bi bi-discord me-1"></i> Buka Tiket Banding
                            </a>
                        </div>
                    </div>
                </div>
