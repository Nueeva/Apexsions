...
<div class="apx-legal-page py-5">
    <div class="container py-4">
        ...
        <div class="apx-section-header text-center mb-5">
            <div class="apx-section-kicker mb-2">KETENTUAN HUKUM &amp; TRANSAKSI</div>
            <h1 class="apx-section-title display-5 mb-3">Syarat &amp; Ketentuan Layanan Webstore</h1>
            ...
            <div class="col-lg-10">
                ...
                <div class="apx-legal-card p-4 p-lg-5 mb-4 rounded" style="background: var(--apx-bg-deep); border: 1px solid var(--apx-border);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="h5 text-white mb-0 font-cinzel">Sifat Produk Virtual &amp; Pengiriman Instan</h2>
                            <span class="text-dim small">Ketentuan Pengiriman Barang Digital Non-Fisik</span>
                        </div>
                    </div>
                    ...
                    <ul class="text-muted small mb-0 ps-3" style="line-height: 1.8;">
                        <li>Pesanan diproses dan dikirimkan secara instan melalui sistem sinkronisasi otomatis <code>WebBridgeService</code> segera setelah status pembayaran dikonfirmasi.</li>
                        <li>Pastikan username Minecraft yang Anda masukkan saat checkout persis sama dengan akun di dalam game. Kesalahan pengetikan nama akun di luar tanggung jawab sistem otomatis.</li>
                    </ul>
                </div>
                ...
                <div class="apx-legal-card p-4 p-lg-5 mb-4 rounded" style="background: var(--apx-bg-deep); border: 1px solid var(--apx-border);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="h5 text-white mb-0 font-cinzel">Kanal Pembayaran Resmi &amp; Verifikasi</h2>
                            <span class="text-dim small">Saluran Transaksi Terverifikasi Manajemen</span>
                        </div>
                    </div>
                    <p class="text-muted small mb-3" style="line-height: 1.8;">
                ...
                <div class="apx-legal-card p-4 p-lg-5 mb-4 rounded" style="background: var(--apx-bg-deep); border: 1px solid var(--apx-border);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="h5 text-white mb-0 font-cinzel">Kebijakan Pengembalian Dana &amp; Anti-Chargeback</h2>
                            <span class="text-dim small">Klausul Final Transaksi &amp; Penegakan Integritas</span>
                        </div>
                    </div>
                    <p class="text-muted small mb-3" style="line-height: 1.8;">
                    ...
                    <ul class="text-muted small mb-0 ps-3" style="line-height: 1.8;">
                        <li>Tindakan penarikan dana sepihak (chargeback, dispute, atau klaim fraud bank palsu) dianggap sebagai pelanggaran integritas berat dan akan memicu <strong>pemblokiran permanen (Blacklist IP &amp; Akun)</strong> dari seluruh layanan server.</li>
                        <li>Apabila terjadi kendala sistem di mana paket belum terkirim setelah 15 menit pasca-pembayaran berhasil, warga wajib membuka tiket investigasi di Discord resmi dengan melampirkan invoice transfer.</li>
                    </ul>
                </div>
                ...
                <div class="apx-legal-card p-4 p-lg-5 mb-4 rounded" style="background: var(--apx-bg-deep); border: 1px solid var(--apx-border);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="h5 text-white mb-0 font-cinzel">Kepatuhan Hukum &amp; Batasan Hak Donatur</h2>
                            <span class="text-dim small">Donasi Bukan Merupakan Kekebalan Hukum (Immunity)</span>
                        </div>
                    </div>
                    <p class="text-muted small mb-3" style="line-height: 1.8;">
                ...
                <div class="apx-legal-card p-4 p-lg-5 mb-4 rounded" style="background: var(--apx-bg-deep); border: 1px solid var(--apx-border);">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="h5 text-white mb-0 font-cinzel">Kesesuaian Minecraft Commercial Usage Guidelines (EULA)</h2>
                            <span class="text-dim small">Kepatuhan Standar Mojang Studios &amp; Microsoft</span>
                        </div>
                    </div>
                    <p class="text-muted small mb-0" style="line-height: 1.8;">
                ...
                <div class="d-flex align-items-center justify-content-between pt-4 border-top border-secondary border-opacity-15 flex-wrap gap-3">
                    <a href="{{ route('privacy') }}" class="text-gold text-decoration-none small">
                        <i class="bi bi-shield-lock me-1"></i> Baca Kebijakan Privasi &amp; Perlindungan Data &rarr;
                    </a>
