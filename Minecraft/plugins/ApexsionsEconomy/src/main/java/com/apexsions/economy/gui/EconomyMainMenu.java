...
public class EconomyMainMenu extends Gui {
    ...
    public void initialize() {
        ...
        profileLore.add("&7Saldo Rupiah: &e" + (rupiah != null ? NumberFormatUtil.format(rupiahBal, rupiah) : ("Rp. " + String.format("%,.0f", rupiahBal).replace(',', '.'))));
        profileLore.add("&7Saldo Diamond 💎: &e" + (diamond != null ? NumberFormatUtil.format(diamondBal, diamond) : (String.format("%,.0f", diamondBal) + " 💎")));
        profileLore.add("&7Format Lengkap: &f" + (rupiah != null ? NumberFormatUtil.formatFull(rupiahBal, rupiah) : ("Rp. " + String.format("%,.0f", rupiahBal).replace(',', '.'))));
