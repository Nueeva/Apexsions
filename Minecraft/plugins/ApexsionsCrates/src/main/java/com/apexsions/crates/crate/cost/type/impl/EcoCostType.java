package com.apexsions.crates.crate.cost.type.impl;

import org.jetbrains.annotations.NotNull;
import com.apexsions.crates.CratesPlugin;
import com.apexsions.crates.api.cost.CostEntry;
import com.apexsions.crates.crate.cost.CostTypeId;
import com.apexsions.crates.crate.cost.entry.impl.EcoCostEntry;
import com.apexsions.crates.crate.cost.type.AbstractCostType;
...
public class EcoCostType extends AbstractCostType implements LangContainer {
    ...
    public boolean isAvailable() {
        return com.apexsions.economy.api.ApexsionsEconomyProvider.isAvailable() || EconomyBridge.hasCurrency();
    }
    ...
    public CostEntry load(@NotNull FileConfig config, @NotNull String path) {
        String defaultCurrency = com.apexsions.economy.api.ApexsionsEconomyProvider.isAvailable() ? "rupiah" : CurrencyId.VAULT;
        String currencyId = ConfigValue.create(path + ".Currency", defaultCurrency).read(config);
    ...
    public EcoCostEntry createEmpty() {
        String defaultCurrency = com.apexsions.economy.api.ApexsionsEconomyProvider.isAvailable() ? "rupiah" : CurrencyId.VAULT;
        return new EcoCostEntry(this, this.dialogs, defaultCurrency, 0);
    }
}
