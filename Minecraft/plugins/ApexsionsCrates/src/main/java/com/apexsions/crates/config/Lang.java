...
import com.apexsions.crates.crate.limit.CooldownMode;
...
public class Lang implements LangContainer {
    ...
    public static final TextLocale EDITOR_TITLE_MAIN             = LangEntry.builder("Editor.Title.Main").text(BLACK.wrap("ApexsionsCrates Editor"));
