...
public class PaperDialogAdapter {
    ...
    public static boolean showInput(Plugin plugin, Player player, String title, String prompt, String defaultText, Consumer<String> onInput, Runnable onCancel) {
        ...
        try {
            ...
            Component titleComp = Component.text(title != null ? title.replaceAll("§[0-9a-fk-or]", "") : "BATTLEPASS INPUT");
            Component promptComp = Component.text(prompt != null ? prompt.replaceAll("§[0-9a-fk-or]", "") : "Masukkan nilai:");
