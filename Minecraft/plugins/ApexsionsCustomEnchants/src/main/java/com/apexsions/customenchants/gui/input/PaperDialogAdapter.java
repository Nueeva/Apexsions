...
public class PaperDialogAdapter {
    ...
    public static boolean showInput(Plugin plugin, Player player, String title, String prompt, String defaultText, Consumer<String> onInput, Runnable onCancel) {
        ...
        try {
            ...
            Component titleComp = mm.deserialize(title != null ? title : "<gold><b>RENAME ITEM</b></gold>");
            Component promptComp = mm.deserialize(prompt != null ? prompt : "<yellow>Ketik nama baru:</yellow>");
            ...
            Object textInputBuilder = textInputMethod.invoke(null, "input_key", Component.text("Name"));
