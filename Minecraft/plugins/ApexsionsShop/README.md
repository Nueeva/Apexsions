...
## ⌨️ Perintah
- `/shop` - Membuka menu utama pasar
- `/shop <kategori>` - Membuka kategori tertentu
- `/sell` atau `/sellgui` - Membuka GUI jual cepat (drag & drop)
- `/sellhand` - Menjual item di tangan utama
- `/sellall` - Menjual seluruh item valid di inventori
- `/shop reload` - Memuat ulang seluruh konfigurasi
